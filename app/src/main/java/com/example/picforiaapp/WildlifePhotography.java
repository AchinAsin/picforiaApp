...
public class WildlifePhotography extends AppCompatActivity implements RecyclerAdapter.onItemClickListener {

    private DatabaseReference reference;
    private FirebaseStorage mStorage;
    private ArrayList<SerialName> imagesList;
    private ValueEventListener valueEventListener;
    private Context mContext = WildlifePhotography.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wildlife_photography);
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Wildlife Photography");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Photography").child("WildlifePhotography");
    ...
    private void init() {
        ...
        mDBListener=reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerAdapter.setOnItemClickListener(WildlifePhotography.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.upload_menu):
                Intent intent = new Intent(WildlifePhotography.this, UploadActivity.class);
    ...
    public void onItemClick(int position) {
        ...
        intent.putExtra("Category","WildlifePhotography");
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                reference.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(WildlifePhotography.this, "Deleted", Toast.LENGTH_SHORT).show();
                    }
