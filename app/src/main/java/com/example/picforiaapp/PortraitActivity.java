...
public class PortraitActivity extends AppCompatActivity implements RecyclerAdapter.onItemClickListener /*implements RecyclerAdapter.ItemClickedListener*/ {

    private DatabaseReference reference;
    private FirebaseStorage mStorage;
    private ArrayList<SerialName> imagesList;
    private ValueEventListener valueEventListener;
    private Context mContext = PortraitActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Portrait Photography");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Photography").child("PortraitPhotography");
    ...
    private void init() {
        ...
        mDBListener=reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerAdapter.setOnItemClickListener(PortraitActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.upload_menu):
                Intent intent = new Intent(PortraitActivity.this, UploadActivity.class);
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                reference.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(PortraitActivity.this, "Deleted", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(PortraitActivity.this,PortraitActivity.class));
                    }
