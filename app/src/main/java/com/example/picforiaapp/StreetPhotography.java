...
public class StreetPhotography extends AppCompatActivity implements RecyclerAdapter.onItemClickListener {

    private DatabaseReference reference;
    private FirebaseStorage mStorage;
    private ArrayList<SerialName> imagesList;
    private ValueEventListener valueEventListener;
    private Context mContext = StreetPhotography.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_street_photography);
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Street Photography");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Photography").child("StreetPhotography");
    ...
    private void init() {
        ...
        mDBListener=reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerAdapter.setOnItemClickListener(StreetPhotography.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.upload_menu):
                Intent intent = new Intent(StreetPhotography.this, UploadActivity.class);
    ...
    public void onItemClick(int position) {
        ...
        intent.putExtra("Category","StreetPhotography");
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                reference.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(StreetPhotography.this, "Deleted", Toast.LENGTH_SHORT).show();
