...
public class NightActivity extends AppCompatActivity implements RecyclerAdapter.onItemClickListener {

    private DatabaseReference reference;
    private FirebaseStorage mStorage;
    private ArrayList<SerialName> imagesList;
    private ValueEventListener valueEventListener;
    private Context mContext = NightActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Night Photography");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Photography").child("NightPhotography");
    ...
    private void init() {
        ...
        mDBListener=reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerAdapter.setOnItemClickListener(NightActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.upload_menu):
                Intent intent = new Intent(NightActivity.this, UploadActivity.class);
    ...
    public void onItemClick(int position) {
        ...
        intent.putExtra("Category","NightPhotography");
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                reference.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(NightActivity.this, "Deleted", Toast.LENGTH_SHORT).show();
