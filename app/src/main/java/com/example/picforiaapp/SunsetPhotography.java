...
public class SunsetPhotography extends AppCompatActivity implements RecyclerAdapter.onItemClickListener {

    private DatabaseReference reference;
    private FirebaseStorage mStorage;
    private ArrayList<SerialName> imagesList;
    private ValueEventListener valueEventListener;
    private Context mContext = SunsetPhotography.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sunset_photography);
        if (getSupportActionBar() != null){
            getSupportActionBar().setTitle("Sunset Photography");
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Photography").child("SunsetPhotography");
    ...
    private void init() {
        ...
        mDBListener=reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                recyclerAdapter.setOnItemClickListener(SunsetPhotography.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case (R.id.upload_menu):
                Intent intent = new Intent(SunsetPhotography.this, UploadActivity.class);
    ...
    public void onItemClick(int position) {
        ...
        intent.putExtra("Category","SunsetPhotography");
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                reference.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(SunsetPhotography.this, "Deleted", Toast.LENGTH_SHORT).show();
